...
import upload_area from '../../assets/Icons/cloud-upload.png'
    ...
    <div className='add-product'>
        ...
        <div className="addproduct-itemfield">
            ...
            <select value={productDetails.category} onChange={changeHandler} name="category" className='add-product-selector'>
                ...
                <option value="body">Hair and Body</option>
        ...
        <div className="addproduct-itemfield">
            ...
            <textarea value={productDetails.description} onChange={changeHandlerDesc}  rows="4" cols="50">
            </textarea>
        </div>
